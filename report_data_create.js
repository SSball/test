...
async function main () {
  ...
  //登録処理  
  await c.goto('https://adplat-dev-console.lognos.com/admin/dashboard_manage/edit?p%5Bclient_id%5D='+id)
  
  await c.type('[id=DashboardEditFormDashboardName]',"test_noda_No."+noFrom)
